...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="mapaDelDelito.php" target="_blank">Mapa del Delito</a>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <p class="text-muted">Diseñada especialemente para que cualquiera pueda usarla, desde niños hasta abuelos!</p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <div class="feature-item">
                    ...
                    <h3>Gratuita</h3>
                    <p class="text-muted">Este servicio es gratis para todos aquellos que la necesiten!</p>
                  </div>
                </div>
              </div>
            </div>
